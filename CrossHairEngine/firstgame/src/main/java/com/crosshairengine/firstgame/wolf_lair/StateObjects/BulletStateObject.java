...
public class BulletStateObject extends StateObject {
    ...
    public BulletStateObject(String sDirectionName, int timeActionProgressBeforeObjectCreation, int timeLengthOfAction) {
